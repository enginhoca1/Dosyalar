...
(
	...
	DepartmanAd VARCHAR(30) UNIQUE NOT NULL,
	PRIMARY KEY(ID)
)
...
--tblUnvan tablosuna veri giriþi
INSERT INTO
	tblUnvan
VALUES
	('Muhendis'),
...
(
	...
	IlID CHAR(2) NOT NULL REFERENCES tblIl(ID)
)
...
VALUES
	...
	('Muratpaþa','07'),('Demre','07'),('Alanya','07')
...
(
	...
	PRIMARY KEY(ID),
	FOREIGN KEY(IlceID) REFERENCES tblIlce(ID),
	FOREIGN KEY(DepartmanID) REFERENCES tblDepartman(ID),
	FOREIGN KEY(UnvanID) REFERENCES tblUnvan(ID)
)
...
(
	...
	PRIMARY KEY(ID),
	FOREIGN KEY(ProjeID) REFERENCES tblProje(ID),
